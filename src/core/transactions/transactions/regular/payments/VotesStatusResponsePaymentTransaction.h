#ifndef VTCPD_VOUTESSTATUSRESPONSEPAYMENTTRANSACTION_H
#define VTCPD_VOUTESSTATUSRESPONSEPAYMENTTRANSACTION_H
...
#endif //VTCPD_VOUTESSTATUSRESPONSEPAYMENTTRANSACTION_H
