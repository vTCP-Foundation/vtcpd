...
TransactionResult::SharedConst SetOutgoingTrustLineTransaction::startBlockNumberRequest()
{
...
TransactionResult::SharedConst SetOutgoingTrustLineTransaction::runBlockNumberRequestStage()
{
