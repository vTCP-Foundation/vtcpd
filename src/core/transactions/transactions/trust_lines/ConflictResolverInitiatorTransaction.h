#ifndef VTCPD_CONFLICTRESOLVERINITIATORTRANSACTION_H
#define VTCPD_CONFLICTRESOLVERINITIATORTRANSACTION_H
...
#endif //VTCPD_CONFLICTRESOLVERINITIATORTRANSACTION_H
